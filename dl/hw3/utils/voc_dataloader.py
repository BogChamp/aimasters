...
from voc_dataset      import VOCDetection, light_transform, test_transform
...
def get_train_dataloader(dataset_root_dir, annotation_file, batch_size, num_workers, batch_transform=light_transform):
    train_dataset    = VOCDetection(dataset_root_dir, annotation_file, batch_transform)
...
def get_test_dataloader(dataset_root_dir, annotation_file, batch_size, num_workers, batch_transform=test_transform):
    test_dataset    = VOCDetection(dataset_root_dir, annotation_file, batch_transform)
